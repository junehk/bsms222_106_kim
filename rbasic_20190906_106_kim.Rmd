...
**Warning**: Factors can be a sourde of confusion since sometimes they behave like characters and sometimes they do not. As a result, confusing factors and characters are a common source of bugs.
...
'data.frame':	51 obs. of  5 variables:
 ...
 $ total     : num  135 19 232 93 1257 ...
~~~
    state, abb, region, poplutaion, and total
...
[37] "OK" "OR" "PA" "RI" "SC" "SD" "TN" "TX" "UT" "VT" "VA" "WA" "WV" "WI" "WY"
> b <- c(murders$abb)
> b
 [1] "AL" "AK" "AZ" "AR" "CA" "CO" "CT" "DE" "DC" "FL" "GA" "HI" "ID" "IL" "IN" "IA" "KS" "KY"
[19] "LA" "ME" "MD" "MA" "MI" "MN" "MS" "MO" "MT" "NE" "NV" "NH" "NJ" "NM" "NY" "NC" "ND" "OH"
